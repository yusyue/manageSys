...
<link rel="stylesheet" href="${path}/loginPage/fifthPage/css/normalize.css">
<link rel="stylesheet" href="${path}/loginPage/fifthPage/css/login.css">
<link rel="stylesheet" href="${path}/loginPage/fifthPage/css/sign-up-login.css">
<link rel="stylesheet" type="text/css" href="http://cdn.bootcss.com/font-awesome/4.6.0/css/font-awesome.min.css">
<link rel="stylesheet" href="${path}/loginPage/fifthPage/css/inputEffect.css" />
<link rel="stylesheet" href="${path}/loginPage/fifthPage/css/tooltips.css" />
<link rel="stylesheet" href="${path}/loginPage/fifthPage/css/spop.min.css" />

<script src="${path}/loginPage/fifthPage/js/jquery.min.js"></script>
<script src="${path}/loginPage/fifthPage/js/snow.js"></script>
<script src="${path}/loginPage/fifthPage/js/jquery.pure.tooltips.js"></script>
<script src="${path}/loginPage/fifthPage/js/spop.min.js"></script>
<script>	
	(function() {
...
body{
	...
	background-image: url(${path}/loginPage/fifthPage/images/snow.jpg);
