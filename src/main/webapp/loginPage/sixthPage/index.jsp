...
<head>
	...
	<!-- Meta tag Keywords -->
	<!-- css files -->
	<link rel="stylesheet" href="${path}/loginPage/sixthPage/css/style.css" type="text/css" media="all" />
	<!-- Style-CSS -->
	<link rel="stylesheet" href="${path}/loginPage/sixthPage/css/fontawesome-all.css">
...
<body>
	...
	<!-- Jquery -->
	<script src="${path}/loginPage/sixthPage/js/jquery-3.3.1.min.js"></script>
	<!-- //Jquery -->

	<!-- effect js -->
	<script src="${path}/loginPage/sixthPage/js/canva_moving_effect.js"></script>
	<!-- //effect js -->
